...
const Signin = (props) => {
    ...
    const [isAgency, setIsAgency] = useState('agency');
    ...
    const onSubmit = async (e) => {
        ...
        if(result.error) {
            ...
            const data = await userAuthService.signin(email, password, isAgency);
            if(data.status < 300) {
    ...
    return ( 
        <div className="signin-main-container">
            ...
            <div className="signin-radio-container">
                <label className="signin-radio-input-container" htmlFor="agency">
                    <input 
                        type="radio" 
                        id="agency"  
                        name="isAgency"   
                ...
                <label className="signin-radio-input-container" htmlFor="guide">
                    <input 
                        type="radio" 
                        id="guide"  
                        name="isAgency"   
